                        ...
                        <div className='col d-inline-flex justify-content-evenly'>
                            <div className='btn-group btn-group-sm' role='group'>
                                <div className='btn-group dropup'>
                                    <button
                                        className='btn btn-outline-success btn-sm animated'
                                        type='button'
                                        style={{ fontSize: '1.25rem' }}
                                        onClick={(() => this.comms.emit('mute', !this.state.muted)).bind(this)}
                                    >
                                        {
                                            !this.state.muted ?
                                        ...
                                        <span className='d-none d-sm-inline' style={{ fontSize: '1rem' }}>  <strong id='muteAudio[0]'>{this.state.muted ? 'Unmute Mic' : 'Mute Mic'}</strong><br /></span>
                                    </button>
                                    {/*
                                        <button
                                ...
                                <div className='btn-group dropup'>
                                    <button
                                        className='btn btn-outline-primary btn-sm animated'
                                        type='button'
                                        style={{ fontSize: '1.25rem' }}
                                        onClick={(() => this.comms.emit('videoDisable', !this.state.videoDisabled)).bind(this)}
                                    >
                                        {
                                        ...
                                        &nbsp;
                                        <span className='d-none d-sm-inline' style={{ fontSize: '1rem' }}>  <strong id='hideVideo[0]'>{this.state.videoDisabled ? 'Enable Video' : 'Disable Video'}</strong></span>
                                    </button>
                                    {/*<button
                            ...
                            <button className='btn btn-outline-light btn-sm animated' type='button' data-bs-target='#modal-1' data-bs-toggle='modal' style={{ fontSize: '1.25rem' }}>
                                <svg
                                ...
                                &nbsp;
                                <span className='d-none d-sm-inline' style={{ fontSize: '1rem' }}>  <strong id='hideVideo[0]'>Settings</strong></span>
                            </button>
                        </div>
                    </div>
                </div>
